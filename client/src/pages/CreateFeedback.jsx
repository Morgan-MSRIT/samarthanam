			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
					<div className="text-center mb-8">
						...
						<p className="mt-2 text-sm text-secondary">
							We value your feedback to improve our events and
							services.
						</p>
					</div>
					...
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div>
							...
							<textarea
								...
								name="additionalInfo"
								rows={3}
								className="mt-1 block w-full rounded-md border-primary-300 shadow-sm focus:border-primary focus:ring-primary text-primary bg-accent placeholder:pl-2 placeholder:pt-1"
