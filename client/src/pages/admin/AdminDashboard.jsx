...
//             <div className="bg-accent p-8 rounded-lg shadow-md w-full max-w-md text-center">
//                 <h1 className="text-3xl font-bold text-primary mb-6">Admin Dashboard</h1>

//                 <Link
//                     to="/admin/create-organizer"
//                     className="block bg-primary text-white p-2 rounded-md w-full mb-4 hover:bg-secondary"
//                 >
//                     Create Organizer
//                 </Link>
...
//                 <Link
//                     to="/admin/analytics"
//                     className="block bg-primary text-white p-2 rounded-md w-full hover:bg-secondary"
//                 >
//                     View Analytics
//                 </Link>
//             </div>
